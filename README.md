...
Se realiza la implementaciÃ³n de polimorfismo para que los mÃ©todos de tipo producto, admitan los productos fisicos
...
Por ultimo, se aplican los conceptos de abastracción creando una nueva clase abstracta llamada Item, está clase contiene la información más básica de los productos, identificador, nombre y precio. Para mantener la jerarquía propuesta, producto extiende a item y de esta manera todas sus subclases podrán acceder a dichos atributos.
